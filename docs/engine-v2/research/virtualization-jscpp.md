...
**`ShadowTreeMutator`** (`packages/nitro-css/cpp/fabric/ShadowTreeMutator.{hpp,cpp}`) —
...
**`LayoutObserver`** (`packages/nitro-css/cpp/fabric/LayoutObserver.{hpp,cpp}`) — our
...
**Node linking** (`packages/nitro-css/cpp/registry/LinkedNode.hpp`,

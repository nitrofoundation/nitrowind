...
## 1. Current JS grid — `packages/nitrowind/src/components/grid.tsx`

File: `/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/src/components/grid.tsx` (790 lines).
...
Consumers:
- `/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/src/components/View.tsx:61`
...
- `/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/src/hoc/withNitrowind.tsx:397`
...
Test coverage today:
`/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/src/components/__tests__/grid.test.ts`
exercises `withGridFallback` output shapes (widths, spans, areas, templates).

---

## 2. Existing native engine — `packages/nitrowind/cpp/grid/`

Files:
- `/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/cpp/grid/GridTypes.hpp`
- `/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/cpp/grid/GridLayoutEngine.hpp`
- `/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/cpp/grid/GridLayoutEngine.cpp`
...
3. Nitro spec: `/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/src/specs/ShadowRegistry.nitro.ts:38`
   → C++ `HybridShadowRegistry::link`
   (`/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/cpp/HybridShadowRegistry.hpp:30`)
...
`/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/cpp/registry/LinkedNode.hpp`
(the `LinkedNode` struct — add grid fields here, mirroring `isContainer` /
`containerName`).

### 3b. Post-layout observer — `packages/nitrowind/cpp/fabric/LayoutObserver.*`

This is the hook the prompt refers to. File
`/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/cpp/fabric/LayoutObserver.cpp`.
...
### 3c. Commit path — `packages/nitrowind/cpp/fabric/ShadowTreeMutator`

`/Users/ashwithsaldanha/MyWork/nitrowind/packages/nitrowind/cpp/fabric/ShadowTreeMutator.cpp`.

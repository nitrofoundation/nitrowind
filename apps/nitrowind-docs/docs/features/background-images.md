...
<img className="docs-feature-image" src="/img/features/native-responsive-surfaces.png" alt="Native background image and container query feature illustration" />
...
<img className="docs-feature-image" src="/img/features/background-repeat-demo.svg" alt="Background repeat, repeat-x, and repeat-y comparison using a high-contrast tile" />

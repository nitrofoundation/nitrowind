...
<div className="docs-hero">
  ...
  <h1>Nitrowind</h1>
  <p>
    Open-source Tailwind v4 bindings for React Native, powered by a native C++ ShadowTree engine
    that updates theme, color-scheme, safe-area, container, and group-state styles without putting
    React back on the render path.
  </p>
  <div className="docs-actions">
    <a className="docs-action docs-action-primary" href="/docs/getting-started/installation">
      Get started
    </a>
    <a className="docs-action" href="/docs/core-concepts/how-it-works">
      How it works
    </a>
  </div>
</div>

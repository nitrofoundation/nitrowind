...
<div className="docs-hero">
  ...
  <p>
    Give an agent focused, up-to-date workflows for the parts of Nitrowind that benefit from careful
    native React Native decisions: setup, theming, container layouts, background images, effects,
    animations, SVG, and component interop.
  </p>
  <div className="docs-actions">
    <a className="docs-action docs-action-primary" href="#skill-builder">
      Build a skill
    </a>

...
<img
  ...
  src="/img/features/native-engine-pipeline.png"
  alt="NitroWind native engine pipeline illustration"
/>
...
<View className="h-44 overflow-hidden rounded-2xl bg-photo bg-cover">
  <Text className="m-4 rounded-lg bg-black/50 px-3 py-1 text-white">No extra Image child</Text>
</View>
```

...
<img
  ...
  alt="Responsive container query cards"
/>
...
<View className="@container rounded-2xl border border-border p-4">
  <Text className="text-sm @min-[280px]:text-lg">I respond to my container width.</Text>
</View>
```
...
<View className="@container/sidebar p-4">
  <Text className="@min-[320px]/sidebar:text-lg">I read the sidebar container.</Text>
</View>
```

 ...
 */
export type ShadowNodeRef = CustomType<AnyObject, "std::shared_ptr<const facebook::react::ShadowNode>", {
 ...
 */
export type FollyDynamic = CustomType<AnyObject, "::nitrowind::SharedFolly", {
...
export declare enum RuntimeChangeSource {
    System = 0,
    User = 1,
    Layout = 2
}

...
export interface NitrowindRuntime extends HybridObject<{
    ...
    onResolveClassNames(listener: (payload: ResolveClassNamesPayload) => void): () => void;
    /**
     ...
     */
    onDependencyChange(listener: (dependencies: StyleDependency[]) => void, dependencies: StyleDependency[] | undefined): () => void;
}
//# sourceMappingURL=NitrowindRuntime.nitro.d.ts.map
...
export type RNStyleValue = string | number | readonly (string | number)[] | InsetValue
/** `fontVariant`. */
 | readonly string[]
...
export type KeyframeStep = Record<string, string | number | ReadonlyArray<Record<string, string | number>>>;
...
export declare const isInsetValue: (value: unknown) => value is InsetValue;

...
import type { ColorScheme, Dimensions, Insets, Orientation, RuntimeSnapshot, RuntimeChangeSource, StyleDependency, ThemeConfig } from "./types";
...
export interface NativePlatform extends HybridObject<{
     ...
     */
    addRuntimeChangeListener(listener: (dependencies: StyleDependency[], runtime: RuntimeSnapshot, source: RuntimeChangeSource) => void): void;
}

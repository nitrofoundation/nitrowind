...
export interface NitrowindDiagnostics extends HybridObject<{
    ...
    onShadowNodeRegistered(listener: (tag: number, className: string, count: number) => void): void;
    onShadowNodeUnregistered(listener: (tag: number, count: number) => void): void;
    onShadowTreeUpdate(listener: (updates: DiagnosticUpdate[]) => void): void;
}
//# sourceMappingURL=NitrowindDiagnostics.nitro.d.ts.map
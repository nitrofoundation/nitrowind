...
exports.buildExitingAnimation = exports.buildEnteringAnimation = void 0;
exports.buildLayoutAnimation = buildLayoutAnimation;
exports.extractAnimationConfig = extractAnimationConfig;
exports.hasReanimatedVars = void 0;
exports.parseTimeToMs = parseTimeToMs;
var _reanimated = require("../compiler/reanimated.js");
/**
...
const ENTERING_EXITING_NAMES = new Set(_reanimated.ENTERING_EXITING_PRESETS);
const LAYOUT_NAMES = new Set(_reanimated.LAYOUT_PRESETS);
...
function extractAnimationConfig(vars, prefix) {
...
const buildEnteringAnimation = vars => buildEnteringExiting(vars, "entering");

/** Build the Reanimated *exiting* animation from `--reanimated-exiting*`. */
exports.buildEnteringAnimation = buildEnteringAnimation;
const buildExitingAnimation = vars => buildEnteringExiting(vars, "exiting");

/** Build the Reanimated *layout* transition from `--reanimated-layout*`. */
exports.buildExitingAnimation = buildExitingAnimation;
function buildLayoutAnimation(vars) {
...
const hasReanimatedVars = vars => vars["--reanimated-entering"] !== undefined || vars["--reanimated-exiting"] !== undefined || vars["--reanimated-layout"] !== undefined;
exports.hasReanimatedVars = hasReanimatedVars;

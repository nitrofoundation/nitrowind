...
Object.defineProperty(exports, "StyleDependency", {
  enumerable: true,
  get: function () {
    return _types.StyleDependency;
  }
});
exports.isInsetValue = void 0;
...
const isInsetValue = value => typeof value === "object" && value !== null && typeof value.$inset === "string";
...
exports.isInsetValue = isInsetValue;

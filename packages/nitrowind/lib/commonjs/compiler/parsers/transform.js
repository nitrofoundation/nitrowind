...
exports.TRANSFORM_AXES = void 0;
exports.extractTransform = extractTransform;
exports.isTransformProp = void 0;
 ...
 */
const TRANSFORM_AXES = exports.TRANSFORM_AXES = ["perspective", "translateX", "translateY", "rotate", "rotateX", "rotateY", "rotateZ", "skewX", "skewY", "scaleX", "scaleY"];
/**
 ...
 */
const isTransformProp = prop => prop === "transform" || prop === "translate" || prop === "scale" || prop === "rotate" || prop.startsWith("--tw-translate-") || prop.startsWith("--tw-scale-") || prop.startsWith("--tw-skew-") || prop.startsWith("--tw-rotate-");
 ...
 */
function extractTransform(declarations, resolveVar, rem) {
  const out = {};
  ...
  const lengthAxis = (prop, axis) => {
    ...
    const px = (0, _insetValue.lengthToPx)(raw, resolveVar, rem);

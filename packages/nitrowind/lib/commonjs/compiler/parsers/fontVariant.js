...
exports.extractFontVariant = extractFontVariant;
exports.isFontVariantProp = void 0;
 ...
 */
function extractFontVariant(declarations, resolveVar) {
...
const isFontVariantProp = prop => prop === "font-variant" || prop.startsWith("font-variant-");
exports.isFontVariantProp = isFontVariantProp;

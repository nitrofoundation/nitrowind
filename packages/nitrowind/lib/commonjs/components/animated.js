...
exports.getAnimatedView = exports.getAnimatedText = void 0;
/**
...
const getAnimatedView = () => loadAnimated()?.View ?? null;

/** Reanimated's `Animated.Text`, or `null` if reanimated isn't installed. */
exports.getAnimatedView = getAnimatedView;
const getAnimatedText = () => loadAnimated()?.Text ?? null;
...
exports.getAnimatedText = getAnimatedText;

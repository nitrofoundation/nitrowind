...
namespace margelo::nitro::nitrowind {
  ...
  public:
    Insets() = default;
    explicit Insets(double top, double right, double bottom, double left): top(top), right(right), bottom(bottom), left(left) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitrowind::Insets> final {
    static inline margelo::nitro::nitrowind::Insets fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrowind::Insets(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrowind::Insets& arg) {
